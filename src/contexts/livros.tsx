...
export const listaLivros: ILivro[] = [
	{
		id: '0',
		isbn: '9788555341052',
		titulo: 'O Timbre',
	...
	},
	{
		id: '2',
		isbn: '9788543108674',
		titulo: 'O grande livro de ciências do Manual do Mundo',
		autores: ['Manual do Mundo', 'Workman Publishing'],
		editora: 'Sextante',
		dataPub: '2020-11-05',
		descricao:
			'Com um milhão de exemplares vendidos no mundo, este livro traz INCRÍVEIS e DIVERTIDAS anotações para você aprender sobre a vida, o Universo e tudo mais. Com mais de 14 milhões de inscritos, o Manual do Mundo é considerado pelo Guinness World Records o maior canal de Ciência e Tecnologia em língua portuguesa do planeta! Nada mais natural, então, que este Grande Livro de Ciências – um dos maiores sucessos da coleção americana Big Fat Notebook, que vendeu 4 milhões de exemplares – chegasse ao Brasil com a chancela do Manual do Mundo. Supercolorido, rabiscado de marca-texto e com ilustrações engraçadas, este livro é garantia de informação – e diversão – de qualidade. A matéria vai grudar na sua mente feito cola com: macetes de memória, definições simples, tabelas práticas e testes de conhecimento.Tudo para você tirar as MELHORES NOTAS! Neste volume, revisto e atualizado pelo Manual do Mundo, você vai encontrar: universo e sistema solar, reações químicas, investigação científica, Leis de Newton, eletricidade e magnetismo, estrutura da terra, sistemas corpóreos, teoria celular, clima, evolução e fósseis, ecossistemas e muito mais.',
		categorias: ['Fiction'],
		thumbnail:
			'http://books.google.com/books/content?id=ikMgEAAAQBAJ&printsec=frontcover&img=1&zoom=1&edge=curl&source=gbs_api',
		lingua: 'pt',
		formato: 'digital',
	},
	{
		...
		categorias: ['Fiction'],
		thumbnail:
			'https://m.media-amazon.com/images/I/91A88pW0+CL._SL1500_.jpg',
		lingua: 'pt',
		formato: 'digital',
	},
];
